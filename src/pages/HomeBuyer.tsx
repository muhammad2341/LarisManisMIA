...
export const HomeBuyer: React.FC = () => {
  ...
  return (
    <main className="min-h-screen pt-24">
      ...
      {/* Chatbot CTA (restored design) — will be placed below the carousel */}
      ...
      {/* Chatbot CTA below the carousel */}
      <section className="relative px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="mb-6 rounded-2xl border border-blue-200 bg-gradient-to-r from-blue-50 to-purple-50 p-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 text-white">
              <span className="text-base font-extrabold">LM</span>
              <span className="absolute -top-1 -right-1 text-yellow-300 text-xs">✦</span>
            </div>
            <div>
              <p className="font-extrabold text-slate-900 text-base md:text-lg">Tanyakan AI Laris Manis</p>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4 text-white font-bold text-base md:text-lg shadow-2xl hover:opacity-95"
            >
              Buka Chat AI
            </button>
          </div>
